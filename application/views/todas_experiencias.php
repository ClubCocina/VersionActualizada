        ...
        <li class="overflowauto" id="<?= str_replace(" ", "_", $experiencia['nombre']);?>">
        	...
        	<div class="titulo-fantasia col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                        ...
                        <a href="http://facebook.com/sharer.php?u=<?= base_url('chef/'.$experiencia['chef'][0]['link']).'#'.str_replace(" ", "_", $experiencia['nombre'])?>"><i class="fa fa-facebook"></i></a>
                        <a href="https://twitter.com/intent/tweet?text=<?= base_url('chef/'.$experiencia['chef'][0]['link']).'#'.str_replace(" ", "_", $experiencia['nombre'])?>"><i class="fa fa-twitter"></i></a>            </div>
                    </div>
                </div>                        
            </div>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $("#platos-btn<?= $experiencia['idExperiencia']; ?>").click(function(){
                        $("#cotizador<?= $experiencia['idExperiencia']; ?>").fadeOut(900);
                        $("#cotizador<?= $experiencia['idExperiencia']; ?>").removeClass('show');
                        $("#cotizador<?= $experiencia['idExperiencia']; ?>").addClass('hidden');
                        $("#platos-experiencia<?= $experiencia['idExperiencia']; ?>").removeClass('hidden');
                        $("#platos-experiencia<?= $experiencia['idExperiencia']; ?>").fadeIn(900);
                        $("#platos-experiencia<?= $experiencia['idExperiencia']; ?>").addClass('show');
                        $("#cotizador-btn<?= $experiencia['idExperiencia']; ?>").removeClass('btn-xs-option-active');
                        $("#platos-btn<?= $experiencia['idExperiencia']; ?>").addClass('btn-xs-option-active');
                    });

                    $("#cotizador-btn<?= $experiencia['idExperiencia']; ?>").click(function(){
                        $("#platos-experiencia<?= $experiencia['idExperiencia']; ?>").fadeOut(900);
                        $("#platos-experiencia<?= $experiencia['idExperiencia']; ?>").removeClass('show');
                        $("#platos-experiencia<?= $experiencia['idExperiencia']; ?>").addClass('hidden');
                        $("#cotizador<?= $experiencia['idExperiencia']; ?>").removeClass('hidden hidden-xs');
                        $("#cotizador<?= $experiencia['idExperiencia']; ?>").fadeIn(900);
                        $("#cotizador<?= $experiencia['idExperiencia']; ?>").addClass('show');     
                        $("#cotizador-btn<?= $experiencia['idExperiencia']; ?>").addClass('btn-xs-option-active');
                        $("#platos-btn<?= $experiencia['idExperiencia']; ?>").removeClass('btn-xs-option-active');
                    });
                });    
            </script>
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="texto-fantasia margin-bottom">
                        <div class="texto-fantasia-wrapper">
                            ...
                            <div id="platos-experiencia<?= $experiencia['idExperiencia']; ?>" class="show">
                    ...
                    <div class="info-actividad bg-rojo margin-bottom">                    
                        <div class="info-cotizador bg-rojo">
                            ...
                            <form class="form-compra" action="<?= base_url('chefs/verDatosChef/' . $experiencia['chef'][0]['idUsuario']); ?>" method="POST">
                                ...
                                <?php endif; ?>
                                <div class="bg-rojo-oscuro-btn-cotizador">
