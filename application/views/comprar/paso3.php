<div class="col-xs-12 col-sm-10 col-sm-offset-1">
    ...
    <div id="ingreso-datos" class="bg-color-general">
        ...
        <div id="ingreso-datos-centro">
            <div class="row">
                <div id="msje-izquierda" class="col-xs-12 col-sm-6">
                    <div>
                        <img class="img-responsive" src="<?= base_url('images/mensaje-conf-pago.png'); ?>" alt="background"/>
                    </div>
                    ...
                    <div class="logo-wp-pago"><img class="img-responsive" src="<?= base_url('images/logo-tb.jpg'); ?>" alt="logo transbank"/></div>
                </div>
                <div id="detalle-derecha" class="col-xs-12 col-sm-6">
                    <div id="tabla-info" class="info-actividad bg-rojo">
                        <table>
                            <tr>
                ...
                <div class="row">
                    <div id="avanzar-compra" class="col-xs-offset-7 col-sm-offset-10">
                        <input id="siguiente" type="submit" class="btn-pagar" value="Pagar" />
                    </div>
                </div>
                <?= form_close(); ?>
            </div>
